...
class TradingStrategy(Strategy):
    def __init__(self):
        # --- NITRO SERIES K (CORRECTED LOGIC) ---
        # "Entry-Only Governor" Restored.
        # This allows existing winners to run even if SPY drops.
    ...
    def run(self, data):
        ...
        if not self.debug_printed:
            log(f"NITRO CORRECTED: Entry-Only Governor Active. Winners Allowed to Run.")
        ...
        # 2. GOVERNOR CHECK (The Fix)
        # ONLY return SGOV if we are not already in a trade.
        ...
        # This remains a hard exit because VXX spikes are dangerous.
