...
class TradingStrategy(Strategy):
    def __init__(self):
        # --- NITRO UNIVERSE (STRESS TESTED) ---
        # REMOVED: "SILJ" (The Lucky Break)
        # REMAINING: Tech, Energy, Defense, Uranium
        ...
        # --- PARAMETERS (SNIPER CONFIG) ---
        self.vix_ma_len = 390  
        self.mom_len = 40      
        self.safe_len = 20     
        self.atr_period = 14
        
        # Cooldown: 12 bars (1 hour)
    ...
    def run(self, data):
        ...
        if not self.debug_printed:
            try:
                log(f"STRESS TEST: Asset List -> {self.tickers}")
            except:
                pass
