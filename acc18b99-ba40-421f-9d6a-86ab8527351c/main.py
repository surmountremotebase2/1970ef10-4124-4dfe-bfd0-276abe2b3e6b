...
class TradingStrategy(Strategy):
    def __init__(self):
        # --- NITRO UNIVERSAL ENGINE (SERIES K) ---
        # OFFICIAL 2026 PARTNERSHIP VERSION
        # Status: VALIDATED.
        # Roster: Option A (Commodity Heavy / Silver Included).
        ...
        # The sweet spot between "too slow" (5-Day) and "too fast" (1-Hour).
        self.trend_len = 156  
       
        # SAFETY LOCKOUT: 3.5 Hours (39 bars)
        # CRITICAL: This prevents "death by churn."
        # If stopped out, we wait half a day for the dust to settle.
    ...
    def run(self, data):
        ...
        if not self.debug_printed:
            log(f"NITRO SERIES K: LIVE. Gov: 2-Day. Lockout: 3.5hr. Roster: {self.tickers}")
