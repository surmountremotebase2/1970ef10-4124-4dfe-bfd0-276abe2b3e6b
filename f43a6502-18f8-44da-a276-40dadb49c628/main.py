...
class TradingStrategy(Strategy):
    ...
    def run(self, data):
        ...
        # --- FIX #1: Robust Holdings Check ---
        # Checks for 'holdings', if missing checks 'positions', if both missing returns empty dict
        current_positions = data.get("holdings", data.get("positions", {}))
        ...
        # --- FIX #3: Correct Data Parsing for History ---
        # Instead of iterating looking for "symbol", we look inside each time step
        ...
        # --- FIX #4: Correct Syntax for Sorting ---
