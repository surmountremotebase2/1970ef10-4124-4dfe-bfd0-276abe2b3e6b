...
class TradingStrategy(Strategy):
    def __init__(self):
        # --- NITRO SERIES K (RESTORED) ---
        # "Winner Takes All" with Strict Safety
        
        # 1. THE NITRO ROSTER
        # We upgraded Uranium to URAA (2x) to match the speed of the others.
        # We removed FNGU (Redundant) to focus the capital.
        self.tickers = ["SOXL", "DFEN", "UCO", "BITU", "SILJ", "URAA"]
        ...
        # --- PARAMETERS ---
        self.vix_ma_len = 390 # 5 Days (5min bars)
    ...
    def run(self, data):
        ...
        if not self.debug_printed:
            log(f"NITRO RESTORED: URAA (2x Uranium) Added. Strict Governor Active.")
        ...
        # 2. GOVERNOR CHECK (The "45% Return" Safety)
        # If SPY is down over 2 days, we sit in cash. Period.
