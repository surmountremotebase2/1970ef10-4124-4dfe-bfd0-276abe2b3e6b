...
class TradingStrategy(Strategy):
    def __init__(self):
        ...
        # --- COOLDOWN PARAMETER ---
        # The number of bars to wait after a stop loss before re-entering
        # 12 bars * 5 mins = 60 minutes cooldown
        ...
        # Track when we last stopped out: {ticker: bar_index}
    ...
    def run(self, data):
        ...
        current_bar_index = len(d) # Simple way to track time
        ...
        if is_defensive:
            ...
            if p_hist:
                ...
                if current_price <= self.entry_price - (2.5 * atr):
                    log(f"STOP: 2.5x ATR Hit on {self.primary_asset}. Cooling down.")
                ...
                # ROTATION: Stage 2 (Trailing Stop 3.5x)
