...
class TradingStrategy(Strategy):
    def __init__(self):
        ...
        # ACTION: Swapped URNM (1x) -> UTSL (3x Utilities).
        # REASON: Maintains a leveraged power-generation proxy that avoids Tech/Oil overlap,
        # while providing deep historical data for long-term Surmount backtesting.
        # ACTION: Swapped SILJ (Miners) -> AGQ (2x Silver Bullion).
        
        self.tickers = ["SOXL", "FNGU", "DFEN", "UCO", "UTSL", "BITU", "AGQ"]
    ...
    def run(self, data):
        ...
        if not self.debug_printed:
            log(f"NITRO K: Max Leverage Active. UTSL integrated. Entry-Only Governor.")
