...
class TradingStrategy(Strategy):
    def __init__(self):
        # --- NITRO SERIES K (ORIGINAL) ---
        # RESTORED: FNGU added back. URNM (1x) restored.
        # This is the configuration that yielded 45%.
    ...
    def run(self, data):
        ...
        if not self.debug_printed:
            log(f"NITRO ORIGINAL: FNGU & URNM Restored. Back to baseline.")
