"""
SEED GOLD -- hold TQQQ while the Nasdaq trend is intact, hold GOLD when
it is not. Never sits in cash, never fully out of the market.

    QQQ above its 200-day average (by BAND)  ->  100% TQQQ
    QQQ below it (by BAND)                   ->  FLOOR in TQQQ, rest GLD

--------------------------------------------------------------------------
MEASURED PERFORMANCE, split-adjusted data, $100,000
...
The edge lives in bear markets. Over five years it made $261,348 of
profit against buy-and-hold's $90,419 -- and essentially ALL of that gap
came from 2022. In bull years it roughly keeps pace. That is the product.
...
GOLD IS NOT RISK-FREE. It fell 45% from 2011-2015. If the gate is off
during a gold bear you lose money in the safe half. Cash cannot do that.
Set PARK = "SHY" for the timid version (~40% less terminal value).

IT DOES NOT PREVENT RUIN. A dot-com-scale grind still does severe damage.
This buys return and softens drawdowns; it is not insurance.

IT LOSES OVER 2010-2026. $24.5M against buy-and-hold's $29.5M. That
window contains no early bear market and five years of chop that the gate
paid for and never collected on. Every result here is window-dependent.
"""
