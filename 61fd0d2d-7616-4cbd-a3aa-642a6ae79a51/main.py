...
class TradingStrategy(Strategy):
    def __init__(self):
        ...
        # Objective: Aggressive growth for <$25k accounts (Cash Account).
        ...
        # Fast reaction to catch rebounds in a cash account.
        self.trend_len = 156   
        
        # COMPLIANCE LOCKOUT: 3.5 Hours (39 bars)
        # Prevents PDT/Settlement violations while allowing same-day re-entry.
