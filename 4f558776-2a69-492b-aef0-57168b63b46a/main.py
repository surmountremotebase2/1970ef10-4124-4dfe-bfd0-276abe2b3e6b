...
class TradingStrategy(Strategy):
    def __init__(self):
        ...
        # Smart Stop Multipliers (Volatility-Adjusted)
    ...
    @property
    def interval(self):
        # TEMPORARILY 1hour to prevent the backtester from hanging
        return "1hour" 
    ...
    def run(self, data):
        ...
        # Adjusted for 1-hour interval (~5 trading days)
        ...
        for t in self.offensive_assets:
            ...
            # Adjusted for 1-hour interval (~40 trading days)
            if len(prices) > 300:
